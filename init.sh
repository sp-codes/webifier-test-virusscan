...
apt-get -y update
apt-get install -y wget httrack python clamav lib32ncurses5 lib32z1 libfontconfig1 libfreetype6 libglib2.0-0 libice6 libsm6 libx11-6 libxext6 libxrender1
